...
# bash <(wget --no-cache -O - https://github.com/Kiritzai/WijZijnDeIT/raw/master/Debian_Desktop.sh)
# curl -sSL https://github.com/Kiritzai/WijZijnDeIT/raw/master/Debian_Desktop.sh | bash
